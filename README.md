...
when installing epoll, it's very likely that gcc/g++ 4.8 are not installed. See
[Node.js v4 and native addons](https://github.com/fivdi/onoff/wiki/Node.js-v4-and-native-addons)
for details.

If you're having issues installing epoll with Node.js v0.10.29 on the BeagleBone Black see
